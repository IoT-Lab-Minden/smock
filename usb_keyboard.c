...
static const uint32_t ui32NumUsageCodes = sizeof(g_pcUsageCodes)
        / sizeof(sUsageEntry);
...
static const uint32_t ui32NumUsageCodesShift = sizeof(g_pcUsageCodes)
        / sizeof(sUsageEntry);
...
void USBKeyboardUpdate(uint8_t ui8Modifiers, uint8_t ui8Key, bool bPressed)
{
    uint8_t ui8Usage;
